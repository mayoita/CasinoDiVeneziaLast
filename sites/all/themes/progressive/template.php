...
function progressive_webform_date($variables) {
    $element = $variables['element'];
...
function progressive_webform_time($variables) {
    $element = $variables['element'];
    ...
    $output = '<div class="webform-container-inline massimo">' . drupal_render($element['hour']) . drupal_render($element['minute']) . drupal_render($element['ampm']) . '</div>';

    return $output;
}
function progressive_form_alter(&$form, $form_state, $form_id) {
